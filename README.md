...
## Before you start
- this is fastapi version if you wants its flask version which is more maintained then check out `https://github.com/novaxmd/BmbApi.git`
...
- **Made in Tanzania** 🇹🇿 - Optimized for Tanzanian music platforms (JioSaavn integration)
...
git clone https://github.com/novaxmd/BmbApi.git
cd BmbApi
...
MIT License © 2025 BmbApi Contributors

See [LICENSE](LICENSE) file for details.

## 🙏 Special Thanks

- **sigma67** - [ytmusicapi](https://github.com/novaxmd/NOVA-XMD)
